...
interface JQueryPromiseOperator<T, U> {
    (callback1: JQueryPromiseCallback<T>|JQueryPromiseCallback<T>[], ...callbacksN: (JQueryPromiseCallback<any>|JQueryPromiseCallback<any>[])[]): JQueryPromise<U>;
}
...
interface JQueryPromise<T> extends JQueryGenericPromise<T> {
     ...
     */
    always(alwaysCallback1?: JQueryPromiseCallback<any>|JQueryPromiseCallback<any>[], ...alwaysCallbacksN: (JQueryPromiseCallback<any>|JQueryPromiseCallback<any>[])[]): JQueryPromise<T>;
    /**
     ...
     */
    done(doneCallback1?: JQueryPromiseCallback<T>|JQueryPromiseCallback<T>[], ...doneCallbackN: (JQueryPromiseCallback<T>|JQueryPromiseCallback<T>[])[]): JQueryPromise<T>;
    /**
     ...
     */
    fail(failCallback1?: JQueryPromiseCallback<any>|JQueryPromiseCallback<any>[], ...failCallbacksN: (JQueryPromiseCallback<any>|JQueryPromiseCallback<any>[])[]): JQueryPromise<T>;
    /**
     * Add handlers to be called when the Deferred object generates progress notifications.
     *
     * @param progressCallbacks A function, or array of functions, to be called when the Deferred generates progress notifications.
     */
    progress(progressCallback1?: JQueryPromiseCallback<any>|JQueryPromiseCallback<any>[], ...progressCallbackN: (JQueryPromiseCallback<any>|JQueryPromiseCallback<any>[])[]): JQueryPromise<T>;
...
interface JQueryDeferred<T> extends JQueryGenericPromise<T> {
     ...
     * @param alwaysCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is resolved or rejected.
     */
    always(alwaysCallback1?: JQueryPromiseCallback<any>|JQueryPromiseCallback<any>[], ...alwaysCallbacksN: (JQueryPromiseCallback<any>|JQueryPromiseCallback<any>[])[]): JQueryDeferred<T>;
    /**
     * Add handlers to be called when the Deferred object is resolved.
     *
     * @param doneCallbacks1 A function, or array of functions, that are called when the Deferred is resolved.
     * @param doneCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is resolved.
     */
    done(doneCallback1?: JQueryPromiseCallback<T>|JQueryPromiseCallback<T>[], ...doneCallbackN: (JQueryPromiseCallback<T>|JQueryPromiseCallback<T>[])[]): JQueryDeferred<T>;
    /**
     * Add handlers to be called when the Deferred object is rejected.
     *
     * @param failCallbacks1 A function, or array of functions, that are called when the Deferred is rejected.
     * @param failCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is rejected.
     */
    fail(failCallback1?: JQueryPromiseCallback<any>|JQueryPromiseCallback<any>[], ...failCallbacksN: (JQueryPromiseCallback<any>|JQueryPromiseCallback<any>[])[]): JQueryDeferred<T>;
    /**
     * Add handlers to be called when the Deferred object generates progress notifications.
     *
     * @param progressCallbacks A function, or array of functions, to be called when the Deferred generates progress notifications.
     */
    progress(progressCallback1?: JQueryPromiseCallback<any>|JQueryPromiseCallback<any>[], ...progressCallbackN: (JQueryPromiseCallback<any>|JQueryPromiseCallback<any>[])[]): JQueryDeferred<T>;
...
interface JQueryStatic {
     ...
     */
    when<T>(...deferreds: (T|JQueryPromise<T>/* as JQueryDeferred<T> */)[]): JQueryPromise<T>;
